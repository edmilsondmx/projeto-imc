...
function calcular(){
    ...
    if (imc > 30){
        res.innerHTML = `<p>Olá ${no}. Seu Índice de Massa Corporal é de ${imc.toFixed(2)}</p>`
        res.innerHTML += '<p>De acordo com a OMS, seu IMC está muito acima do recomendado para a sua altura!</p>'
        ...
        res.innerHTML = `<p>Olá ${no}. Seu Índice de Massa Corporal é de ${imc.toFixed(2)}</p>`
        res.innerHTML += '<p>De acordo com a OMS, seu IMC está abaixo do recomendado para a sua altura!</p> '
        ...
        res.innerHTML = `<p>Olá ${no}. Seu Índice de Massa Corporal é de ${imc.toFixed(2)}</p>`
        res.innerHTML += '<p>De acordo com a OMS, seu IMC é considerado normal para a sua altura!</p>'
        ...
        res.innerHTML = `<p>Olá ${no}. Seu Índice de Massa Corporal é de ${imc.toFixed(2)}</p>`
        res.innerHTML += '<p>De acordo com a OMS, seu IMC está acima do recomendado para a sua altura!</p>'
